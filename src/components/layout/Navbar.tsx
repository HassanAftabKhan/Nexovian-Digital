      ...
      >
        <div className="container-default flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2 group" id="navbar-logo">
            <Image
              src="/nexoviandigital logo.svg"
              alt="NexovianDigital Logo"
              width={75}
              height={75}
              className="rounded-lg object-cover group-hover:shadow-[0_0_20px_rgba(0,212,255,0.4)] transition-shadow duration-500"
              priority
            />
